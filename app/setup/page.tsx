        ...
        <div className="w-full flex flex-col items-center">
          ...
          >
            {allDone
              ...
              : 'ztory runs on your own accounts, so it needs a few connections before it will start. Grab each value and paste it into your environment.'}
          </p>
                  ...
                  >
                    ...
                    >
                      ...
                      <p
                        ...
                        style={{ fontWeight: 300, color: 'rgba(240,237,230,0.6)' }}
                      >
                        ztory tried to create them for you and couldn&apos;t. {schema.error}
                      </p>
                    </div>
                    <ol
                    ...
                    >
                      ...
                      <li>
                        ...
                        the ztory folder, copy everything in it, paste it into the console and press{' '}
          ...
          <div className="w-full flex flex-col gap-5">
            ...
            >
              <p
                ...
                style={{ fontFamily: 'var(--font-montserrat)', fontWeight: 500, color: OFF_WHITE }}
              >
                Running ztory on your own computer
              </p>
              <ol
                className="m-0 pl-4 flex flex-col gap-1.5 text-[11.5px] leading-relaxed"
                style={{ fontWeight: 300, color: 'rgba(240,237,230,0.55)' }}
              >
                <li>
                  Open the ztory folder you downloaded. Find the file called{' '}
                ...
                <li>Save the file.</li>
                <li>
                  Stop ztory in the terminal (press{' '}
            ...
            >
              ...
              >
                <li>
                  ...
                  ztory project, then <span style={{ color: OFF_WHITE }}>Settings → Environment
                  Variables</span>.
                </li>
                <li>
